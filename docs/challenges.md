...
The trouble with this differentiation is that it's not particularly falsifiable. There's not really a way to validate, concretely, that you possess an objective and correct understanding of the reason a system (or any person for that matter) exists as they do. Even in finding a clear link between a traumatic event and systemhood, this *must* be treated as belief, otherwise anyone could easily claim that some third criteria has its hand in *both* the trauma and plurality (e.g. autism) and we're back to square one.
