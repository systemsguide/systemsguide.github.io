...
The trouble with this differentiation is that it's not falsifiable. There's no way to validate that you possess an objective and correct understanding of the reason a system exists as it does, even in yourself. As a result, these beliefs segregate systems into the diagnosed and the overconfident as the in-group, and everyone else as the out-group.
