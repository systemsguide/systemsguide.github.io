...
The trouble with this differentiation is that it's not particularly falsifiable. There's not really a way to validate, concretely, that you possess an objective and correct understanding of the reason a system (or any person for that matter) exists as they do. To solidify this, consider that even showing a clear link between a traumatic event and systemhood can be challenged by alternative explanations such as a third phenomena causing both the trauma and plurality - autism, for example. This forces us to consider both hypotheses as beliefs, not facts.
