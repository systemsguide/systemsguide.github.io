...
_This is an extract from the original union version._
...
Pluralfolk frequently have their own preferences in regards to specific terminology, however, here are some more common terms which will be used throughout this resource:
...
* **(The) Original**
    ...
    * [Causal Prescriptivism](#causal-prescriptivism-and-faith). Many systems simply don’t have an “Original” headmate, and find the concept uncomfortable.
...
* **Multiple Personalities**
    ...
    * [Causal Prescriptivism](#causal-prescriptivism-and-faith). Also, describing system members as “personalities” is reductive. Might imply relation to MPD (see below).
* **“People with MPD/DID/OSDD” (in place of “Plural”)**
    * Used to describe the nature of a system (or all systems).
    * [System Bucketing](#system-bucketing). Also sysmedicalism - implies that systems must receive a specific diagnosis in order to be plural.
* **Alter**
...
* **Traumagenic/Endogenic**
    ...
    * [Causal Prescriptivism](#causal-prescriptivism-and-faith) and [System Bucketing](#system-bucketing). This supposed binary doesn’t exist without discarding all non-psychological casualties (or distaste for causalities altogether) a system might have. 
...
* **Persecutor/Protector/Etc (Headmate Archetype Labels)**
    ...
    * [System Bucketing (#3 - Member Archetypes)](#system-bucketing). Harmful in that it devalues the individual and pushes them away from further self exploration
* **“More Plural” or “Less Plural”**
    * Used to talk about togetherness/separateness of individuals and systems, as well as when talking about [median systems](#medianity-and-the-plural-umbrella).
