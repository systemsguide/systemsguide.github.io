...
A system might have names for each of their members, an overall system name but no member names, a system name _and_ member names, many names per member, two headmates that share a name, a few members without names, patterned names that reflect how the system works, and much more!
...
While both have their exceptions, different parts of a system can vary in that "gut feeling" of gender, and so might use unique pronouns, gendered language, or even hold a differing conceptions of their trans-ness.

### Relationships

A notable variance in system configuration is in what bleeds over (or stays constant) between headmates.
...
These "causalities" - including spiritual and cultural truths, psychological mechanisms, and deliberate actions - aren't necessary to understand oneself as plural. 
Regardless, they can help an individual system understand themselves - even if that understanding is "we are how we are - it doesn't matter why".
