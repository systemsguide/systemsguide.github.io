...
_"In many ways it feels like our transition was not Male to Female, but a transition to Plural. To being able to be understood as multiple, and as disparate genders within specific social spaces"_
...
- **Physical features/Appearance:** how someone looks.
- **Race:** the social construct. Created by processes of racialization and oppression. Historically contingent and separate from the racialized features it is mapped onto.
- **Culture:** the collections of beliefs, language and practices shared by a particular social or ethnic group.
...
These perceptions can change, and open up new possibilities for personal expression. Maybe your body doesn't always need to change to meet your internal self, instead letting these perceptions exist in dialogue with one another: The hormones that change your body, the allegories and signifiers you adorn yourself with - horn headbands and collars, and the allowance for images of yourself to get fatter, include mobility aids, or any other part of yourself deemed less palatable by society. [In acceptance of the existence of this dialogue, there are more opportunities to embody parts of yourself that cannot otherwise be physically manifested, in age regression, in animality, in your multiplicity itself]

[The paragraph that feels like we are also bookending the race section (i.e. an outside-in perspective, the lack of nuanced discussion in the field, hoping the reader can take this away and have not just the correct opinions but rather better discussions with those around them)]
